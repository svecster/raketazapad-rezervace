-- ======================================
-- SUPABASE SCHEMA FIX PACK - CORRECT ENUM VALUES
-- ======================================
...
-- Create RLS policy for staff to access products through the view
CREATE POLICY "products_staff_view_access" ON public.products_staff_view
FOR SELECT USING (
  public.get_user_role(auth.uid()) = ANY (ARRAY['staff'::user_role, 'owner'::user_role])
);