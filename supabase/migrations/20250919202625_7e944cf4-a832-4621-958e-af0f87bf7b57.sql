...
-- Insert test courts (using valid court_status enum values)
...
('c3333333-3333-3333-3333-333333333333', 'Kurt 3', 'outdoor', 'unavailable', '{"spring": {"weekday": 400, "weekend": 500}, "summer": {"weekday": 450, "weekend": 550}, "autumn": {"weekday": 350, "weekend": 450}, "winter": {"weekday": 300, "weekend": 400}}'),
...
('iaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Sendvič šunka-sýr', 85, 8, '2024-12-15 12:45:00+01');
...
('ca111111-1111-1111-1111-111111111111', 'ch111111-1111-1111-1111-111111111111', 'Petr Dvořák', 555, 555, 'paid', 'full', '{}', '[{"method": "cash", "amount": 555}]', '["33333333-3333-3333-3333-333333333333"]'),
('ca222222-2222-2222-2222-222222222222', 'ch222222-2222-2222-2222-222222222222', 'Lucie & Eva', 670, 670, 'paid', 'equal', '{"split_count": 2}', '[{"method": "cash", "amount": 335}, {"method": "qr_payment", "amount": 335}]', '["88888888-8888-8888-8888-888888888888", "66666666-6666-6666-6666-666666666666"]');
...
('ci111111-1111-1111-1111-111111111111', 'ch111111-1111-1111-1111-111111111111', 'ca111111-1111-1111-1111-111111111111', 'Rezervace Kurt 1', 'reservation', 450, 1, 450, '90 min rezervace', 'RK001'),
('ci222222-2222-2222-2222-222222222222', 'ch111111-1111-1111-1111-111111111111', 'ca111111-1111-1111-1111-111111111111', 'Coca Cola 0.5l', 'bar', 35, 3, 105, 'Nápoje během hry', 'CC001'),
('ci333333-3333-3333-3333-333333333333', 'ch222222-2222-2222-2222-222222222222', 'ca222222-2222-2222-2222-222222222222', 'Rezervace Kurt 2', 'reservation', 500, 1, 500, 'Víkendová rezervace 90 min', 'RK002'),
('ci444444-4444-4444-4444-444444444444', 'ch222222-2222-2222-2222-222222222222', 'ca222222-2222-2222-2222-222222222222', 'Minerální voda 0.5l', 'bar', 25, 4, 100, 'Voda pro hráče', 'MV001'),
('ci555555-5555-5555-5555-555555555555', 'ch222222-2222-2222-2222-222222222222', 'ca222222-2222-2222-2222-222222222222', 'Energetický nápoj', 'bar', 65, 1, 65, 'Red Bull', 'RB001'),
('ci666666-6666-6666-6666-666666666666', 'ch222222-2222-2222-2222-222222222222', 'ca222222-2222-2222-2222-222222222222', 'Sleva věrný zákazník', 'discount', -5, 1, -5, '5 Kč sleva', 'SL001');
...
('cp111111-1111-1111-1111-111111111111', 'ca111111-1111-1111-1111-111111111111', 555, 'cash', 600, 45, NULL, NULL, '11111111-1111-1111-1111-111111111111', '2024-12-14 10:30:00+01', 'Hotovostní platba s vrácením'),
('cp222222-2222-2222-2222-222222222222', 'ca222222-2222-2222-2222-222222222222', 335, 'cash', 340, 5, NULL, NULL, '22222222-2222-2222-2222-222222222222', '2024-12-15 11:45:00+01', 'Hotovost - první polovina'),
('cp333333-3333-3333-3333-333333333333', 'ca222222-2222-2222-2222-222222222222', 335, 'qr_payment', NULL, NULL, 'TK240001', 'SPD*1.0*480*CZK*RF12345678901234567890123456*TENISOVY KLUB RAKETA*TK240001*Tenisový klub - platba', '22222222-2222-2222-2222-222222222222', '2024-12-15 11:48:00+01', 'QR platba - druhá polovina');
...
('bo111111-1111-1111-1111-111111111111', 'r1111111-1111-1111-1111-111111111111', '[{"name": "Coca Cola 0.5l", "quantity": 3, "unit_price": 35, "total_price": 105}]', 105, 'cash', 'paid', '11111111-1111-1111-1111-111111111111', '2024-12-14 14:15:00+01', '2024-12-14 14:10:00+01'),
('bo222222-2222-2222-2222-222222222222', 'r6666666-6666-6666-6666-666666666666', '[{"name": "Minerální voda 0.5l", "quantity": 2, "unit_price": 25, "total_price": 50}, {"name": "Proteinová tyčinka", "quantity": 1, "unit_price": 45, "total_price": 45}]', 95, 'qr_payment', 'paid', '22222222-2222-2222-2222-222222222222', '2024-12-15 12:30:00+01', '2024-12-15 12:25:00+01');

-- Insert test audit logs
INSERT INTO public.audit_logs (id, action, user_id, details, timestamp) VALUES
('al111111-1111-1111-1111-111111111111', 'reservation_created', '11111111-1111-1111-1111-111111111111', '{"reservation_id": "r1111111-1111-1111-1111-111111111111", "court": "Kurt 1", "user": "Petr Dvořák"}', '2024-12-14 10:15:00+01'),
('al222222-2222-2222-2222-222222222222', 'payment_confirmed', '11111111-1111-1111-1111-111111111111', '{"reservation_id": "r1111111-1111-1111-1111-111111111111", "amount": 450, "method": "cash"}', '2024-12-14 10:30:00+01'),
('al333333-3333-3333-3333-333333333333', 'inventory_updated', '22222222-2222-2222-2222-222222222222', '{"item": "Tenisové míčky Wilson", "old_stock": 45, "new_stock": 50}', '2024-12-15 16:20:00+01'),
('al444444-4444-4444-4444-444444444444', 'shift_opened', '11111111-1111-1111-1111-111111111111', '{"shift_id": "s3333333-3333-3333-3333-333333333333", "opening_balance": 8200}', '2024-12-16 08:00:00+01'),
('al555555-5555-5555-5555-555555555555', 'checkout_completed', '22222222-2222-2222-2222-222222222222', '{"checkout_id": "ch222222-2222-2222-2222-222222222222", "total": 670, "split_accounts": 1}', '2024-12-15 11:50:00+01');
...
('ps111111-1111-1111-1111-111111111111', true, true, 'Tenisový klub Raketa', 'CZ1234567890123456789012', '0300', 'TK', 'Tenisový klub - platba', true, true, true);

-- Insert cash register entry
INSERT INTO public.cash_register (id, shift_id, cash_in, cash_out, balance, notes) VALUES
('cr111111-1111-1111-1111-111111111111', 's3333333-3333-3333-3333-333333333333', 1450, 200, 9450, 'Aktuální stav pokladny');