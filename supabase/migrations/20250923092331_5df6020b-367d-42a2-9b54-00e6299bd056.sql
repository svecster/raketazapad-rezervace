-- ======================================
-- SUPABASE SCHEMA FIX PACK - Fixed
-- ======================================

-- Step 1: Role + Helper - Fix function signature conflict
...
-- Drop existing function with the old signature
...
-- Fix sales.reservation_id type and foreign key
DO $$
BEGIN
