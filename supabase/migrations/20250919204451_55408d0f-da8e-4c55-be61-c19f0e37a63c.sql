...
-- Add 8 more cash ledger entries with correct enum values
DO $$
DECLARE
    user_ids uuid[];
    shift_ids uuid[];
BEGIN
    ...
    (400, 'cash_in', 'Platba za rezervaci kurtu', 'reservation', user_ids[1], shift_ids[1], 'ÚK005', 'Ranní rezervace', '2024-12-23 10:15:00+01'),
    (125, 'sale_cash', 'Prodej občerstvení', 'bar_order', user_ids[2], shift_ids[1], 'ÚK006', 'Nápoje + sendvič', '2024-12-23 12:30:00+01'),
    (650, 'cash_in', 'Platba za krytý kurt', 'reservation', user_ids[3], shift_ids[2], 'ÚK007', 'Premium rezervace', '2024-12-23 14:45:00+01'),
    (300, 'cash_out', 'Nákup inventáře', 'inventory', NULL, shift_ids[2], 'FAK125', 'Doplnění nápojů', '2024-12-23 16:20:00+01'),
    (500, 'cash_in', 'Platba za víkendovou rezervaci', 'reservation', user_ids[4], shift_ids[3], 'ÚK008', 'Sobotní rezervace', '2024-12-24 11:20:00+01'),
    (85, 'sale_cash', 'Prodej sportovního vybavení', 'bar_order', user_ids[5], shift_ids[3], 'ÚK009', 'Tenisové míčky', '2024-12-24 13:15:00+01'),
    (750, 'qr_in', 'Platba za turnaj', 'reservation', user_ids[1], shift_ids[4], 'ÚK010', 'Turnajový poplatek', '2024-12-25 15:30:00+01'),
    (150, 'cash_out', 'Oprava vybavení', 'maintenance', NULL, shift_ids[4], 'FAK126', 'Oprava sítě', '2024-12-25 17:45:00+01');
END $$;
